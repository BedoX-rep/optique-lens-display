    ...
    <footer className="bg-gray-900 text-white py-16">
      <div className="max-w-[1440px] mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">OPTIQUE<span className="font-normal">LENS</span></h3>
          ...
          {/* Customer Service */}
          <div>
            <h4 className="font-bold text-gray-100 mb-4">Customer Service</h4>
          ...
          {/* Products */}
          <div>
            <h4 className="font-bold text-gray-100 mb-4">Products</h4>
            <ul className="space-y-2 text-gray-400">
          ...
          {/* About */}
          <div>
            <h4 className="font-bold text-gray-100 mb-4">About</h4>
            <ul className="space-y-2 text-gray-400">
